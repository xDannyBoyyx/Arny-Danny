	...
	this.draw = function(drawFn){
		...
		if (mouseIsPressed){
			...
			//draw a line between them and the current positions
				...
				// drawFunction(previousMouseX, previousMouseY, mouseX, mouseY);
				// toolbox.selectedTool.originalDraw();
		...
		// 		// lineX = line(width / 2, 0, width / 2, height);
		// 		// mirrorLine.push(lineX.clone()); //figure out why this doesn't work plus prevents mirroring.
		// 		pop();

...
function ColourPalette() {
	...
	this.colours = [
        "black", "silver", "gray", "white", "maroon", "red", "purple","orange", "pink",
	...
	var colourClick = function() {
		...
		var oppositeIndex = self.colours.length - 1 - self.colours.indexOf(c);
		var borderColour = self.colours[oppositeIndex];
		this.style("border", `3px solid ${borderColour}`);
	};
